...
public abstract class ShowOutputs {
	 ...
	 */
	public static ShowOutput from(String json) throws DecodeException {
	 ...
	 * JSON encoder.
	 */
	public static class Encoder extends MappedEncoder<ShowOutput, Json> {
	 ...
	 * JSON decoder.
	 */
	public static class Decoder extends MappedDecoder<ShowOutput, Json> {
