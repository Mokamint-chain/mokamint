...
/**
 * Providers of outputs for the {@code mokamint-plotter create} command.
 */
public abstract class CreateOutputs {
	 ...
	 */
	public static CreateOutput from(String json) throws DecodeException {
	 ...
	 * JSON representation.
	 */
	public static class Json extends CreateOutputJson {
		 ...
		 */
		public Json(CreateOutput output) {
			super(output);
		}
	}
	 ...
	 * JSON encoder.
	 */
	public static class Encoder extends MappedEncoder<CreateOutput, Json> {
	 ...
	 * JSON decoder.
	 */
	public static class Decoder extends MappedDecoder<CreateOutput, Json> {
