...
public class BlockDescriptionTests extends AbstractLoggedTests {
	...
	public void encodeDecodeWorksForGenesis() throws EncodeException, DecodeException, NoSuchAlgorithmException, InvalidKeyException, SignatureException {
		...
		var description1 = BlockDescriptions.genesis(LocalDateTime.now(), 4000, HashingAlgorithms.sha256(), HashingAlgorithms.sha256(), HashingAlgorithms.shabal256(), HashingAlgorithms.shabal256(), ed25519, ed25519.getKeyPair().getPublic());
