 ...
 */
@Immutable
public class BaseConsensusConfig implements ConsensusConfig {
	 ...
	 */
	protected BaseConsensusConfig(AbstractBuilder<?> builder) {
	...
	public boolean equals(Object other) {
		if (other != null && getClass() == other.getClass()) {
			var otherConfig = (BaseConsensusConfig) other;
	...
	public static class Builder extends AbstractBuilder<Builder> {
		...
		@Override
		public BaseConsensusConfig build() {
			return new BaseConsensusConfig(this);
		}
	...
	public abstract static class AbstractBuilder<T extends AbstractBuilder<T>> {
		 ...
		 */
		public abstract BaseConsensusConfig build();
