...
public class PeersConnectDisconnectTests extends AbstractLoggedTests {
	...
	public void ifPeerDisconnectsThenRemoteRemoved(@TempDir Path chain1, @TempDir Path chain2, @TempDir Path chain3)
		...
		class MyLocalNode extends LocalNodeImpl {
			...
			private MyLocalNode(LocalNodeConfig config) throws IOException, DatabaseException, InterruptedException, AlreadyInitializedException, InvalidKeyException, SignatureException, TimeoutException, ApplicationException {
	...
	public void ifPeerDisconnectsThenConnectsItIsBackInNetwork(@TempDir Path chain1, @TempDir Path chain2)
		...
		class MyLocalNode1 extends LocalNodeImpl {
			...
			private MyLocalNode1(LocalNodeConfig config) throws NoSuchAlgorithmException, IOException, DatabaseException, InterruptedException, AlreadyInitializedException, InvalidKeyException, SignatureException, TimeoutException, ApplicationException {
				super(config, nodeKey, app, false);
			}
		...
		class MyLocalNode2 extends LocalNodeImpl {
			...
			private MyLocalNode2(LocalNodeConfig config) throws NoSuchAlgorithmException, IOException, DatabaseException, InterruptedException, AlreadyInitializedException, InvalidKeyException, SignatureException, TimeoutException, ApplicationException {
				super(config, nodeKey, app, false);
			}
