...
public final class GetBlockDescriptionMessages {
	 ...
	 * Gson encoder.
	 */
	public static class Encoder extends MappedEncoder<GetBlockDescriptionMessage, Json> {
	 ...
	 * Gson decoder.
	 */
	public static class Decoder extends MappedDecoder<GetBlockDescriptionMessage, Json> {
