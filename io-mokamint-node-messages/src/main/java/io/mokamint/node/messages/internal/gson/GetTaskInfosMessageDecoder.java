...
/**
 * A decoder for {@link GetTaskInfosMessage}.
 */
public class GetTaskInfosMessageDecoder extends BaseDecoder<GetTaskInfosMessage> {

	public GetTaskInfosMessageDecoder() {
		super(GetTaskInfosMessageImpl.class);
	}
}