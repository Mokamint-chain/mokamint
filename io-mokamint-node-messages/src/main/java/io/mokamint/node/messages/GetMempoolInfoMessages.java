...
public final class GetMempoolInfoMessages {
	...
	/**
	 * Yields a {@link GetMempoolInfoMessage}.
	 * 
	 * @param id the identifier of the message
	 * @return the message
	 */
	public static GetMempoolInfoMessage of(String id) {
		return new GetMempoolInfoMessageImpl(id);
	}

	/**
	 * Gson encoder.
	 */
	public static class Encoder extends MappedEncoder<GetMempoolInfoMessage, Json> {
	 ...
	 * Gson decoder.
	 */
	public static class Decoder extends MappedDecoder<GetMempoolInfoMessage, Json> {
