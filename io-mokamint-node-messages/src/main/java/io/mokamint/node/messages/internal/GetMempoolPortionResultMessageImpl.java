...
public class GetMempoolPortionResultMessageImpl extends AbstractRpcMessage implements GetMempoolPortionResultMessage {
	 ...
	 * Creates the message.
	 * 
	 * @param mempool the mempool hashes
	...
	@Override
	public MempoolPortion get() {
		return mempool;
	}

	@Override
	public boolean equals(Object other) {
		return other instanceof GetMempoolPortionResultMessage gmrm && super.equals(other) && Objects.equals(get(), gmrm.get());
	}
