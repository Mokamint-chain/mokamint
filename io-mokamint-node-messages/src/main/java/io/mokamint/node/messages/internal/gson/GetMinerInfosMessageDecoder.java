...
/**
 * A decoder for {@link GetMinerInfosMessage}.
 */
public class GetMinerInfosMessageDecoder extends BaseDecoder<GetMinerInfosMessage> {

	public GetMinerInfosMessageDecoder() {
		super(GetMinerInfosMessageImpl.class);
	}
}