...
public final class GetTaskInfosMessages {
	...
	/**
	 * Yields a {@link GetTaskInfosMessage}.
	 * 
	 * @param id the identifier of the message
	 * @return the message
	 */
	public static GetTaskInfosMessage of(String id) {
		return new GetTaskInfosMessageImpl(id);
	}

	/**
	 * Gson encoder.
	 */
	public static class Encoder extends MappedEncoder<GetTaskInfosMessage, Json> {
	 ...
	 * Gson decoder.
	 */
	public static class Decoder extends MappedDecoder<GetTaskInfosMessage, Json> {
