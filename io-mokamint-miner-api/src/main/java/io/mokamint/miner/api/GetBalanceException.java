...
/**
 * An exception stating that the execution of the method
 * {@link Miner#getBalance(io.hotmoka.crypto.api.SignatureAlgorithm, java.security.PublicKey)} failed.
 */
...
public class GetBalanceException extends Exception {
	...
	public GetBalanceException() {
		super("The balance could not be determined");
	}
