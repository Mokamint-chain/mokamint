...
public abstract class EndBlockResultMessages {
	...
	/**
	 * Yields a {@link EndBlockResultMessage}.
	 * 
	 * @param result the result of the call
	 * @param id the identifier of the message
	 * @return the message
	 */
	public static EndBlockResultMessage of(byte[] result, String id) {
		return new EndBlockResultMessageImpl(result, id);
	}

	/**
	 * Gson encoder.
	 */
	public static class Encoder extends MappedEncoder<EndBlockResultMessage, Json> {
	 ...
	 * Gson decoder.
	 */
	public static class Decoder extends MappedDecoder<EndBlockResultMessage, Json> {
    ...
    public static class Json extends EndBlockResultMessageJson {
    	 ...
    	 */
    	public Json(EndBlockResultMessage message) {
    		super(message);
    	}
    }
}