 ...
 */
public class CheckRequestResultMessageImpl extends AbstractVoidResultMessage implements CheckRequestResultMessage {
	 ...
	 */
	public CheckRequestResultMessageImpl(String id) {
	 ...
	 */
	public CheckRequestResultMessageImpl(CheckRequestResultMessageJson json) throws InconsistentJsonException {
	 ...
	 */
	private <E extends Exception> CheckRequestResultMessageImpl(String id, ExceptionSupplierFromMessage<? extends E> onIllegalArgs) throws E {
		super(id, onIllegalArgs);
	}

	@Override
	public boolean equals(Object other) {
		return other instanceof CheckRequestResultMessage && super.equals(other);
	}

	@Override
	protected String getExpectedType() {
		return CheckRequestResultMessage.class.getName();
	}
}