...
public class KeepFromResultMessageImpl extends AbstractVoidResultMessage implements KeepFromResultMessage {
	 ...
	 */
	public KeepFromResultMessageImpl(KeepFromResultMessageJson json) throws InconsistentJsonException {
	 ...
	 */
	private <E extends Exception> KeepFromResultMessageImpl(String id, ExceptionSupplierFromMessage<? extends E> onIllegalArgs) throws E {
