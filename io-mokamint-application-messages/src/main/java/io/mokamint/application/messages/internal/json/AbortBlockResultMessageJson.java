...
/**
 * The JSON representation of a {@link AbortBlockResultMessage}.
 */
public abstract class AbortBlockResultMessageJson extends AbstractRpcMessageJsonRepresentation<AbortBlockResultMessage> {

	protected AbortBlockResultMessageJson(AbortBlockResultMessage message) {
		super(message);
	}

	@Override
	public AbortBlockResultMessage unmap() throws InconsistentJsonException {
		return new AbortBlockResultMessageImpl(this);
	}
