...
import io.mokamint.node.cli.AbstractPublicRpcCommand.RpcCommandBody;
 ...
 */
public abstract class AbstractPublicRpcCommandImpl extends AbstractRpcCommandWithJsonOutput<RemotePublicNode> {
	...
	protected AbstractPublicRpcCommandImpl() {}
