...
public abstract class ChainInfoOutputs {
	 ...
	 */
	public static ChainInfoOutput from(String json) throws DecodeException {
	...
	public static class Json extends ChainInfoOutputJson {
		 ...
		 */
		public Json(ChainInfoOutput output) {
			super(output);
		}
	}
	 ...
	 * JSON encoder.
	 */
	public static class Encoder extends MappedEncoder<ChainInfoOutput, Json> {
	 ...
	 * JSON decoder.
	 */
	public static class Decoder extends MappedDecoder<ChainInfoOutput, Json> {
