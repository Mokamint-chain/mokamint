...
public class PlotTests extends AbstractLoggedTests {
	...
	public void encodeDecodeWorksForPlot(@TempDir Path dir) throws InvalidKeyException, NoSuchAlgorithmException, IOException, InterruptedException, EncodeException, DecodeException {
