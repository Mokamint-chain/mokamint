...
public abstract class LocalMiners {
	 ...
	 * @param plots the plot files used for mining; this cannot be empty; all plots must be for
	 ...
	 */
	public static LocalMiner of(String name, String description, BalanceProvider balanceProvider, Plot... plots) {
		return new LocalMinerImpl(name, description, balanceProvider, plots);
	}
}
