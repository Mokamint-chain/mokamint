...
```console
$ docker run -it --rm -v chain:/home/mokamint/chain -v mokamint:/home/mokamint/mokamint -e APPLICATION=Parity mokamint/mokamint:1.7.4 init
...
```console
$ docker run -it --rm --name mokamint -e APPLICATION=Parity -p 8025:8025 -p 8030:8030 -p 127.0.0.1:8031:8031 -p 8050:8050 -v mokamint:/home/mokamint/mokamint -v chain:/home/mokamint/chain mokamint/mokamint:1.7.4 go
